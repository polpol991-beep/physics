...
with tab_quiz:
    ...
    if exam_open_flag != '1':
        ...
        if 'quiz_questions' not in st.session_state:
            all_questions = [
                {"level": "중", "q": "길이가 $L$인 질량이 균일한 막대가 줄 A, B에 매달려 정지해 있다. 줄 A는 왼쪽 끝에, 줄 B는 오른쪽 끝에서 $\\frac{1}{3}L$ 떨어진 곳에 있다. A, B가 막대를 당기는 힘의 크기 비 $\\frac{F_A}{F_B}$는?", "img": "img/스크린샷 2026-08-31 154719.png", "options": ["1/3", "1/2", "1", "2", "3"], "answer": "1/3"},
                ...
                {"level": "하", "q": "직선상에서 운동하는 물체의 속도-시간 그래프에서 0\~10초 구간은 속도가 증가하고, 10\~20, $t$\~30초는 등속, 20\~$t$, 30\~40초는 속도가 감소한다. $t<25$일 때, 가속도의 크기가 가장 큰 구간은?", "img": "img/스크린샷 2026-08-31 154751.png", "options": ["0~10초", "10~20초", "20~$t$초", "$t$~30초", "30~40초"], "answer": "20~$t$초"},
